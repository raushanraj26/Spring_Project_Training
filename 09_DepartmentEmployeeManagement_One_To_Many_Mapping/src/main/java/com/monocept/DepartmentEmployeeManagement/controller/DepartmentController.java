...
public class DepartmentController {
	...
	//show all departments with pagination
	 @Operation(summary = "Get all departments with pagination")
	    @ApiResponse(responseCode = "200", description = "Departments fetched successfully")
	@GetMapping("/page")
	public PageResponseDto<DepartmentResponseDto> getAllDepartmentsWithPagination(@RequestParam(defaultValue = "0") int pageNo, @RequestParam(defaultValue = "5") int pageSize) {
